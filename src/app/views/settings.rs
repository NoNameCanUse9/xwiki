                ...
                div()
                                ...
                                div()
                                    ...
                                    .child(
                                        Button::new("settings-test")
                                            ...
                                            .label(if test_busy { "测试中…" } else { "测试连接" })
                                            .loading(test_busy)
                    ...
                    .child(
                        div()
                                ...
                                div()
                                    ...
                                    .child(
                                        div()
                                            ...
                                            .rounded(px(tokens::RADIUS))
                                            .icon(IconName::Redo2)
                                            .label(if access_busy { "加载中…" } else { "刷新" })
                                            .loading(access_busy)
                                            .disabled(access_busy || test_busy)
                                                    .on_click(cx.listener(|this, _, _, cx| {
                            ...
                            .child(if let Some(secret) = &self.settings_token_secret {
                                div()
                                    .flex()
                                    .items_start()
                                    .gap_2()
                            ...
                            } else if let Some(err) = &self.settings_error {
                                div()
                                    .flex()
                                    .items_start()
                                    .gap_2()
                                        ...
                                        div()
                                            ...
                                            .child(if access_busy {
                                                ...
                                                div()
                                                    .v_flex()
                                                    .gap_2()
                                                    .children(self.settings_tokens.iter().map(|token| {
                                        ...
                                        div()
                                            ...
                                            .child(if access_busy {
                                                ...
                                                div()
                                                    .v_flex()
                                                    .gap_2()
                                                    .children(self.settings_users.iter().map(|user| {
